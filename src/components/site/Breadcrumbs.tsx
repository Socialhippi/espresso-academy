            ...
            return (
              <li key={crumb.href} className="flex items-center gap-2">
                ...
                {isCurrent ? (
                  ...
                  <Link
                    href={crumb.href}
                    className="inline-flex min-h-11 min-w-11 items-center justify-center underline decoration-white-2 underline-offset-4 hover:text-red hover:decoration-red"
                  >
                    {crumb.label}
                  </Link>
                )}
